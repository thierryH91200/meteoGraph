    ...
    */
    ...
    /**
     ...
     - Parameters:
        ...
        - error: An error object that indicates why the request failed, or nil if the request was successful.
    */
    public func requestHourlyForecast(with request: WeatherRequest, requestCnt: WeatherRequest, for frequency: ForecastFrequency, completion: @escaping (_ forecast: HourlyForecast?, _ error: Error?) -> ()) {
    ...
    /**
     ...
     - Parameters:
        ...
        - error: An error object that indicates why the request failed, or nil if the request was successful.
    */
    public func requestDailyForecast(with request: WeatherRequest, requestCnt: WeatherRequest, completion: @escaping (_ forecast: DailyForecast?, _ error: Error?) -> ()) {
